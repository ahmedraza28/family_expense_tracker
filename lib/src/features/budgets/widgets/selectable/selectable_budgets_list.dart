...
import 'selectable_budget_list_item.dart';

// Features
import '../../../books/books.dart';

class SelectableBudgetsList extends ConsumerWidget {
  final List<BudgetModel> budgets;

  const SelectableBudgetsList({
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ListView.separated(
      ...
      itemBuilder: (_, i) {
        ...
        final child = SelectableBudgetListItem(
          budget: budgets[i],
