...
import 'selectable_budgets_list.dart';

class SelectableBudgetsView extends ConsumerStatefulWidget {
  const SelectableBudgetsView({super.key});

  @override
  ConsumerState<SelectableBudgetsView> createState() => SelectableBudgetsViewState();
}

class SelectableBudgetsViewState extends ConsumerState<SelectableBudgetsView> {
